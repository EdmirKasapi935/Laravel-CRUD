...
public function update()
{
  ...
  if($validated["imgsrc"] != "" )
   ...
   return to_route("vehicle.show", $this->vehicle->id);
...
<h1 style="text-align: center; font-size: 50px;">Please fill the fields below</h1>
  <div class="mx-auto bg-white shadow-sm rounded-lg  p-6 space-x-2" style="width: 30%;"> 
    <form wire:submit="update" class="max-w-md mx-auto">
     ...
     <label style="margin-right:59px"> Seats: </label> <input type="number" wire:model="seats" class="rounded-md shadow-lg focus:border-indigo-300" max="100" min="1" value="1" style="margin-bottom: 5px;" required><br>
    ...
    <label style="margin-right:51px;">Image:</label> <input type="file" wire:model="imgsrc" class="rounded-md shadow-lg focus:border-indigo-300 "><br>
    ...
    <div class="mt-3" style="margin-left: 99px">
        <a href={{ route("vehicle.show", $vehicle->id) }}> <x-secondary-button> Cancel </x-secondary-button> </a>
    </div>
